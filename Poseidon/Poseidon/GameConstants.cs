...
namespace Poseidon {
    class GameConstants
    {
        ...
        public static int[] NumberTrash =           { 0, 0, 0, 0, 0, 0, 0, 0 };
        ...
        public static int[] NumberShipWreck =       {   0,   5,   5,   0,   0,   5,   5,   0  };
        public static int[] FishInSchool =          { 150, 150, 150,   0, 150, 150, 150,   0  };
