...
namespace Poseidon.GraphicEffects
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        /// </summary>
        public void Draw(GameTime gameTime, Texture2D beforeBloomTexture, RenderTarget2D afterBloomTexture)
        {
            ...
            DrawFullscreenQuad(beforeBloomTexture, renderTarget1,
                               bloomExtractEffect,
            ...
            graphicsDevice.SetRenderTarget(afterBloomTexture);
            ...
            graphicsDevice.Textures[1] = beforeBloomTexture;
