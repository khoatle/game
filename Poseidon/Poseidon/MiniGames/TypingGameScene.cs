    ...
    public class TypingGameScene : GameScene
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (isOver)
            {
                spriteBatch.Begin();
                base.Draw(gameTime);
                string strResult = "You gain " + expAwarded + " experience from the written test!";
                strResult = IngamePresentation.wrapLine(strResult, game.GraphicsDevice.Viewport.Width * 3 / 4, font);
                spriteBatch.DrawString(font, strResult, new Vector2(game.GraphicsDevice.Viewport.TitleSafeArea.Width/2, 50), Color.Red, 0, new Vector2(font.MeasureString(strResult).X/2, font.MeasureString(strResult).Y/2), 1.0f, SpriteEffects.None, 0);
            ...
            Vector2 skipTextPosition = new Vector2(game.GraphicsDevice.Viewport.TitleSafeArea.Right - IngamePresentation.menuSmall.MeasureString(skipText).X * GameConstants.generalTextScaleFactor, game.GraphicsDevice.Viewport.TitleSafeArea.Bottom - IngamePresentation.menuSmall.MeasureString(skipText).Y * GameConstants.generalTextScaleFactor);
