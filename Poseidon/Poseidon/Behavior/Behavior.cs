...
namespace Poseidon
{
    public class Behavior {
        ...
        public static bool isInSight(Vector3 observer, Vector3 other, float threshold) {
            Vector2 observer2 = new Vector2(observer.X, observer.Z);
            Vector2 other2 = new Vector2(other.X, other.Z);

            float dot = Vector2.Dot(observer2, other2);
            float distance = Vector2.Distance(observer2, other2);
